                    ...
                    for (const card of category.cards) {
                        ...
                        if (card.cur_level === 0 && card.is_available) {
                            ...
                            if (upgradeRes.data) {
                                ...
                                this.log(`Đang mua thẻ ${card.name.yellow}...Trạng thái: ${'Thành công'} Balance mới: ${String(balance).yellow}`);
                            } else {
                ...
                while (true) {
                    ...
                    for (const card of allCards) {
                        if (!upgradedThisCycle.has(card.id) && 
                            ...
                            if (upgradeRes.data) {
                                balance = upgradeRes.data.balance;
                                this.log(`Đang nâng cấp thẻ ${card.name.yellow}...Trạng thái: ${'Thành công'} Balance mới: ${String(balance).yellow}`);
                                upgradedAny = true;
